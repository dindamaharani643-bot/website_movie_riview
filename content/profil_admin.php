        ...
        <div class="mv-profile-row">
            ...
            <div class="mv-profile-col-left">
                <div class="mv-profile-card text-center">
                    ...
                    <h4 class="mv-profile-name"><?= htmlspecialchars($data_profil['nama'] ?? 'Movie Lovers'); ?>
                    </h4>
                    <p class="mv-profile-username">@<?= htmlspecialchars($data_profil['user'] ?? 'username'); ?>
                    </p>

                    <div class="mv-badge-wrapper">
                        <?php if (isset($data_profil['id_role']) && $data_profil['id_role'] == 1): ?>
                            <span class="mv-badge-role mv-badge-admin"><i class="fa fa-shield"></i>
                                Administrator</span>
                        <?php else: ?>
            ...
            <div class="mv-profile-col-right">
                <div class="mv-profile-card">
                    <h4 class="mv-profile-title">
                        <i class="fa fa-edit me-2"></i> Perbarui Informasi Profil
                    </h4>
                        ...
                        <div class="mv-form-row">
                            <div class="mv-form-group">
                                ...
                                <select name="jenis_kelamin" class="mv-profile-input">
                                    ...
                                    <option value="pria" <?= (isset($data_profil['jenis_kelamin']) && $data_profil['jenis_kelamin'] == 'pria') ? 'selected' : ''; ?>>Pria
                                    </option>
                                    <option value="wanita" <?= (isset($data_profil['jenis_kelamin']) && $data_profil['jenis_kelamin'] == 'wanita') ? 'selected' : ''; ?>>Wanita
                                    </option>
                                </select>
                            </div>
                            <div class="mv-form-group">
